...
description: ProPainter 视频修复工具通用指南。当用户提到"ProPainter"、"视频修复"、"视频去水印"、"视频擦除"、"视频 inpainting"、"处理视频"、"制作 mask"、"去掉路人"、"去掉水印"、"去掉杂物"、"视频补帧"、"视频填充"、"去除视频水印"、"擦除视频内容"、"视频抠图"、"视频去字幕"、"视频去logo"、"视频去日期"、"视频去时间戳"、"批量处理视频"、"视频批量修复"、"视频自动化处理"、"视频后期处理"、"视频清理"、"视频美化"、"去除视频中的文字"、"去除视频中的物体"、"视频对象移除"、"视频内容感知填充"时使用此 skill。提供完整的操作流程、命令模板、常见工作流和问题解答。适用于任何环境和硬件配置。
---
